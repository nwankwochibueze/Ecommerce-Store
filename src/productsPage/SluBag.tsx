...
import Slu2 from "../assets/SLU-02.webp";
...
const product = {
  ...
  code: "SLU-003",
  description:
    "Striking and sleek, LeParle’s Zebra Print Tote makes a bold style statement with its monochrome pattern and modern edge.",
  price: 77,
  imageUrl: Slu2,
  images: [Slu2],
  info: "Material: Polyester. Size: 50x20x10cm. Color: Black/White.",
  sizes: ["S", "M", "L", "XL"],
};
