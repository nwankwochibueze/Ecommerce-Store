...
import Vxm2 from "../assets/Vxm-02.webp";
...
const product = {
  ...
  code: "VXM-003",
  description:
    "Effortlessly elegant, LeParle’s Suede Shoulder Bag pairs a velvety feel with a clean silhouette—crafted for comfort and perfect for everyday sophistication.",
  price: 119,
  imageUrl: Vxm2,
  images: [Vxm2],
